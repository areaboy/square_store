...
echo "<script>alert('Youtube Processed');</script>";
//echo "<script>window.location = 'https://www.youtube.com/watch?v=$video_id'</script>";
echo "<script>window.open('https://www.youtube.com/watch?v=$video_id', '_blank');</script>";
